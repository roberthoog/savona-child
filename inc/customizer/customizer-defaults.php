...
function savona_options( $control ) {
	...
	$savona_defaults = array(
		...
		'blog_page_post_description' => 'utdrag',
		...
		'blog_page_related_title' => 'Relaterade inlägg',
